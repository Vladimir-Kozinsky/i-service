...
import { editLeg } from "../../../store/reducers/aircraftReducer";
...
const EditLegForm = ({ setAddLegForm, msn, fh, fc, leg }: AddLegFormProps) => {
    ...
    return (
        <div className={s.addLeg} >
            <h3 className={s.addLeg__header}>Edit Leg</h3>
            <Formik
                initialValues={{
                    depDate: leg.depDate,
                ...
                onSubmit={async (
                    ...
                    dispatch(editLeg({ msn, legId: leg._id, updatedLeg }))
                }}
            >
...
export default compose(withContainerBlur)(EditLegForm);