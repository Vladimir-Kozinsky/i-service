                    ...
                    <section className={classNames(s.about__wrap, isAbout && s[active])}>
                        <div className={classNames(s.moove__block, s[active])}>
                            <div className={s.about} >
                                ...
                                {isAbout && <>
                                    <p className={s.about__par}>
                                        Основным критерием деятельности нашей
                                        авиакомпании является строгое соблюдение
                                        и выполнение всех требований гражданской
                                        авиации в области качества, безопасности
                                        полетов и авиационной безопасности.
                                    </p>
                                    <p className={s.about__par}>
                                        Осознавая
                                        важность внедрения в деятельность предприятия
                                        международных систем менеджмента для повышения
                                        конкурентоспособности, престижа и работы на
                                        международном рынке грузовых авиационных
                                        перевозок, на предприятии разработана и
                    ...
                    <section className={s.contacts__wrap} id="contacts">
                        ...
                        <div className={s.contacts} >
                            <div className={s.contacts__address}>
                                <h4 className={s.contacts__address__title}>New Way Cargo Airlines LLC</h4>
